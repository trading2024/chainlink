...
// GetLatestValue provides a mock function with given fields: ctx, contractName, method, params, returnVal, confidenceLevel
func (_m *ChainReader) GetLatestValue(ctx context.Context, contractName string, method string, params interface{}, returnVal interface{}, confidenceLevel primitives.ConfidenceLevel) error {
	ret := _m.Called(ctx, contractName, method, params, returnVal, confidenceLevel)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, interface{}, interface{}, primitives.ConfidenceLevel) error); ok {
		r0 = rf(ctx, contractName, method, params, returnVal, confidenceLevel)
	} else {
		r0 = ret.Error(0)
	}
