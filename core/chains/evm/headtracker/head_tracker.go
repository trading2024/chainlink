...
func (*nullTracker) Backfill(ctx context.Context, headWithChain *evmtypes.Head, latestFinalized *evmtypes.Head) (err error) {
	return nil
}
func (*nullTracker) LatestCanonicalChain() *evmtypes.Head { return nil }
